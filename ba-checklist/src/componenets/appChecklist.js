      ...
      <section className="form-main__wrapper-m form-main__wrapper--form">
        <div className="form-main__wrapper-m__second">
          ...
          <p className="form-main__text">
            You are good to go! We are working only on CPX web just becauase app
            optimisation is done on App store. If you want your feature being
            highlighted on App Store please add a comment below. Cheers!{" "}
          </p>
